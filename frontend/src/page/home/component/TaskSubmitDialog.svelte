<script lang="ts">
    ...
    const handleBatchSubmit = () => {
        ...
        axios.post('/api/task/submit/batch', formData, {
            headers: {
...
<Dialog.Root bind:open>
    ...
    <Dialog.Content class="max-w-4xl">
        <Dialog.Header>
            ...
            <Dialog.Description>
                Submit individual tasks or upload a CSV file for batch processing
            </Dialog.Description>
        </Dialog.Header>

        <div class="flex gap-6 mt-4">
            <!-- Left Column: Individual Task Form -->
            <div class="flex-1 space-y-4">
                ...
                <Button 
                    ...
                    class="w-full"
                    disabled={!selectedCategory || !source.trim()}
                >
                    Submit Task
                </Button>
            </div>
                    ...
                    <div class="flex flex-col items-center space-y-4">
                        ...
                        {:else}
                            <div class="text-center">
                                <p class="text-xs pb-2.5 font-medium text-gray-700">
