            ...
            <div class="space-y-4">
                <table class="w-full text-sm">
                    ...
                    {#if taskDetail.title}
                        <tr class="border-b">
                            ...
                            <td class="py-2 truncate" title={taskDetail.title}>{taskDetail.title}</td>
                        </tr>
                    {/if}
                    {#if taskDetail.source}
                        <tr class="border-b">
                            <td class="py-2 pr-4 font-medium">Source</td>
                            <td class="py-2 max-w-sm runcate">
                                <a
                ...
                <div>
                    ...
                    <div class="h-[400px] overflow-auto rounded-md border bg-gray-50">
                        <pre class="p-4 text-sm whitespace-pre">{taskDetail.content}</pre>
                    </div>
                </div>
            </div>
        {:else}
